...
[top-entity]: img/top_entity.png "Top Entity"
...
The [dht11_sa_top.syn.tcl](syn/dht11_sa_top.syn.tcl) TCL script automates the synthesis.
...
[wfsm]: img/wfsm.png "Write FSM"

#### Read FSM Flow Diagram
![alt text][rfsm]

[rfsm]: img/rfsm.png "Read FSM"
...
The design has been synthesised with the Vivado tool provided by Xilinx and mapped in the programmable logic part of the Zynq core of the Zybo.
The [dht11_axi_top.syn.tcl](syn/dht11_axi_top.syn.tcl) TCL script automates the synthesis.
