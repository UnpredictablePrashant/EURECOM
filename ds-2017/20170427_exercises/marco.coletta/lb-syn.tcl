...
# Create LB project #
#####################
create_project -part $part -force lb lb
add_files sr.vhd timer.vhd lb.vhd
import_files -force -norecurse
ipx::package_project -root_dir lb -vendor www.telecom-paristech.fr -library LB -force lb
close_project
...
set_property ip_repo_paths { ./lb } [current_fileset]
update_ip_catalog
create_bd_design "$top"
set ps7 [create_bd_cell -type ip -vlnv [get_ipdefs *xilinx.com:ip:processing_system7:*] ps7]
set lb [create_bd_cell -type ip -vlnv [get_ipdefs *www.telecom-paristech.fr:LB:lb:*] lb]
...
connect_bd_net [get_bd_pins /lb/clk] [get_bd_ports clk]
create_bd_port -dir I -type rst areset
connect_bd_net [get_bd_pins /lb/areset] [get_bd_ports areset]
create_bd_port -dir O -type data -from 3 -to 0 led
connect_bd_net [get_bd_pins /lb/led] [get_bd_ports led]
